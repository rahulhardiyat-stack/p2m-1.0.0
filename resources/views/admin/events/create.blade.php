...
@section('title', 'Tambah Agenda/Event')

@section('content_header')
    <h1><i class="fas fa-plus me-2"></i>Tambah Agenda</h1>
@stop
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" required placeholder="Contoh: Seminar Nasional Teknologi 2024">
                            @error('title')<span class="invalid-feedback">{{ $message }}</span>@enderror
                        </div>

                        <div class="form-group">
                            <label>Ringkasan Singkat <span class="text-danger">*</span></label>
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3" required placeholder="Gambarkan agenda ini dalam beberapa kalimat singkat...">{{ old('description') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location') }}" required placeholder="Contoh: Aula Utama Lt. 3">
                                @error('location')<span class="invalid-feedback">{{ $message }}</span>@enderror
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Link Online (Zoom/Meet/dll)</label>
                                <input type="url" name="online_url" class="form-control @error('online_url') is-invalid @enderror" value="{{ old('online_url') }}" placeholder="https://zoom.us/j/...">
                        ...
                        <div class="card card-outline card-secondary mt-3">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="seo_title" class="form-control" value="{{ old('seo_title') }}" placeholder="Maks 60 karakter">
                                </div>
                                <div class="form-group">
                                    <label>SEO Description</label>
                                    <textarea name="seo_description" class="form-control" rows="2" placeholder="Maks 160 karakter">{{ old('seo_description') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card card-outline card-info shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="category" class="form-control @error('category') is-invalid @enderror" value="{{ old('category') }}" placeholder="Seminar, Workshop, dll">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_person" class="form-control @error('contact_person') is-invalid @enderror" value="{{ old('contact_person') }}" placeholder="Nama/No HP">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" name="registration_url" class="form-control @error('registration_url') is-invalid @enderror" value="{{ old('registration_url') }}" placeholder="https://bit.ly/reg-acara">
                                </div>

                                <div class="form-group">
                                    <label>Batas Waktu Pendaftaran</label>
                                    <input type="datetime-local" name="registration_deadline" class="form-control @error('registration_deadline') is-invalid @enderror" value="{{ old('registration_deadline') }}">
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="is_free" name="is_free" value="1" {{ old('is_free', true) ? 'checked' : '' }} onchange="document.getElementById('price_container').style.display = this.checked ? 'none' : 'block'">
                                        <label class="custom-control-label" for="is_free">Acara Gratis</label>
                                    </div>
                                </div>
                                
                                <div class="form-group" id="price_container" style="display: {{ old('is_free', true) ? 'none' : 'block' }}">
